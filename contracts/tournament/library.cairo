...
@event
func new_player_registered(
    player_address: felt, total_ship_count: felt, remaining_ship_count: felt
) {
}
...
namespace tournament {
    ...
    func round_battle_transaction_hash{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    }(round: felt, battle_index: felt) -> (hash: felt) {
...
namespace internal {
    ...
    func play_next_battle{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
        ...
        let (local ships_len: felt, ships: ShipInit*) = build_battle_ship_array(playing_ship_index);
    ...
    func play_battle{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        round_battle_transaction_hashes_.write(
            round, played_battle_count, tx_info.transaction_hash
        );

        return (winner_ship.address,);
    }

    func update_won_and_lost_battle_counts{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    ...
    func get_initial_ship_position{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        battle_ship_index: felt
    ...
    func check_for_end_of_tournament{
        ...
        if (playing_ship_count == 1) {
            ...
            IAccount.incrementWonTournamentCount(
                contract_address=account_contract_address, address=winner_address
            );
