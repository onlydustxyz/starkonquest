...
func test_end_to_end_testing{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    ...
    invoke_battle(
        expected_played_battle_count_after=1,
        expected_round_before=1,
        expected_round_after=1,
        battle_contract_address=battle_contract_address,
    ...
    invoke_battle(
        expected_played_battle_count_after=3,
        expected_round_before=1,
        expected_round_after=1,
        battle_contract_address=battle_contract_address,
        tournament_contract_address=tournament_contract_address,
    ...
    %}
    invoke_battle(
        expected_played_battle_count_after=4,
        expected_round_before=1,
        expected_round_after=2,
        battle_contract_address=battle_contract_address,
        tournament_contract_address=tournament_contract_address,
        admin=ADMIN,
    );
    ...
    invoke_battle(
        expected_played_battle_count_after=5,
        expected_round_before=2,
        expected_round_after=3,
        battle_contract_address=battle_contract_address,
        tournament_contract_address=tournament_contract_address,
        admin=ADMIN,
    );
    ...
    %}
    invoke_battle(
        expected_played_battle_count_after=6,
        expected_round_before=2,
        expected_round_after=3,
        battle_contract_address=battle_contract_address,
        tournament_contract_address=tournament_contract_address,
    ...
    %}
    invoke_battle(
        expected_played_battle_count_after=7,
        expected_round_before=3,
        expected_round_after=4,
        battle_contract_address=battle_contract_address,
        tournament_contract_address=tournament_contract_address,
        admin=ADMIN,
    );
...
func _register_ships_loop{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ships_len: felt, ships: felt*, tournament_contract_address: felt
) {
    alloc_locals;
    if (ships_len == 0) {
        return ();
    ...
    // Check registration
    let (registered_player_address) = ITournament.ship_player(
        tournament_contract_address, ship_address
    );
...
func invoke_battle{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
